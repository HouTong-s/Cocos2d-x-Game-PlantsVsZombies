...
vector<string> Plant::PlantsNames = {"向日葵","豌豆射手","寒冰射手","坚果","土豆雷","双发射手"};
int Plant::CardCost[] = {50,100,150,50,25,200};
vector<string> Plant::CardImgs = {"向日葵卡.png","豌豆射手卡.png","寒冰射手卡.png","坚果卡.png","土豆地雷卡.png","双发射手卡.png"};
vector<string> Plant::PlantsImgs = {"向日葵.png","豌豆射手.png","寒冰射手.png","坚果.png","土豆地雷1.png","双发射手.png"};
